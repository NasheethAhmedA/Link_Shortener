...
### 🚀 How It Works
1. **Enter the Long URL** – Paste your long URL into the input field.
2. **Generate Short Link** – Click the shorten button to create a unique link.
3. **Copy & Share** – Use the generated short link anywhere (social media, emails, etc.).
